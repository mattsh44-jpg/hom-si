...
export default function Architecture() {
  ...
  const integrations = [
    ...
    { name: 'Zoho Books', type: 'Finance', status: 'connected', icon: <FileText className="h-4 w-4" /> },
    { name: 'Zoho Invoice', type: 'Billing', status: 'connected', icon: <FileText className="h-4 w-4" /> },
    ...
    { name: 'DocuSign', type: 'E-Signature', status: 'connected', icon: <FileText className="h-4 w-4" /> },
    { name: 'Calendly', type: 'Scheduling', status: 'connected', icon: <Users className="h-4 w-4" /> },
    { name: 'Notion', type: 'Documentation', status: 'connected', icon: <FileText className="h-4 w-4" /> }
  ];
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold mb-3">Finance Stack Integration</h3>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="text-xs text-gray-600 mt-2">
                    • Automated invoice generation from project milestones<br/>
                    • Real-time AR aging and collections tracking<br/>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex items-center justify-between p-2 bg-gray-50 rounded">
                    ...
                    <Badge className="bg-green-100 text-green-800 text-xs">Secondary</Badge>
                  </div>
                  <div className="flex items-center justify-between p-2 bg-gray-50 rounded">
                  ...
                  <div className="text-xs text-gray-600 mt-2">
                    • Multi-agent orchestration and deployment<br/>
                    • Workflow automation and monitoring<br/>
